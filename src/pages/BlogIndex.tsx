...
const blogPosts = [
  { slug: "insurance-regulation-changes-canada-2026", category: "Industry Updates", title: "Insurance Regulation Changes in Canada for 2026: What You Need to Know", description: "OSFI capital updates, AI underwriting rules, climate risk disclosure, privacy changes & lower term rates.", date: "April 14, 2026", readTime: "11 min read" },
  { slug: "critical-illness-insurance-whats-new-2026", category: "Critical Illness", title: "Critical Illness Insurance in 2026: What's New in Canadian Policies", description: "Mental health coverage, hybrid CI-disability products, expanded cancer definitions, multi-pay options.", date: "April 14, 2026", readTime: "10 min read" },
  { slug: "dental-pharmacare-canada-2026", category: "Health", title: "Canada's Dental Care & Pharmacare in 2026: What's Covered and What's Not", description: "CDCP eligibility, pharmacare Phase 1, OHIP gaps, and why private health insurance still matters.", date: "April 14, 2026", readTime: "12 min read" },
